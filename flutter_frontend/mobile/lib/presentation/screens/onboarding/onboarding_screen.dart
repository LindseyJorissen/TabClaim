...
const _pages = [
  _Page(
    ...
    subtitle:
        'Point your camera at any receipt. TabClaim reads the items for you instantly.',
  ...
  _Page(
    ...
    subtitle:
        'Tap each item to assign it. Split shared dishes between people in one tap.',
  ...
  _Page(
    ...
    subtitle:
        'TabClaim does the math and shows exactly who pays who. No spreadsheets needed.',
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          // ── Step icon ────────────────────────────────────────────────
          Icon(page.icon, size: 44, color: Colors.white.withValues(alpha: 0.9))
              .animate()
          ...
          Text(
            ...
            textAlign: TextAlign.center,
              ...
              .slideY(begin: 0.2, end: 0, delay: 150.ms, duration: 300.ms),
          ...
          // ── Wordmark ─────────────────────────────────────────────────
          const TabClaimWordmark(fontSize: 20)
              .animate()
